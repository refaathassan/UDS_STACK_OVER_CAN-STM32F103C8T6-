...
C_SRCS += \
../Core/USRT_MANAGE/USRTM_program.c 

OBJS += \
./Core/USRT_MANAGE/USRTM_program.o 

C_DEPS += \
./Core/USRT_MANAGE/USRTM_program.d 


# Each subdirectory must supply rules for building sources it contributes
Core/USRT_MANAGE/%.o Core/USRT_MANAGE/%.su Core/USRT_MANAGE/%.cyclo: ../Core/USRT_MANAGE/%.c Core/USRT_MANAGE/subdir.mk
...
clean: clean-Core-2f-USRT_MANAGE

clean-Core-2f-USRT_MANAGE:
	-$(RM) ./Core/USRT_MANAGE/USRTM_program.cyclo ./Core/USRT_MANAGE/USRTM_program.d ./Core/USRT_MANAGE/USRTM_program.o ./Core/USRT_MANAGE/USRTM_program.su

.PHONY: clean-Core-2f-USRT_MANAGE
